...
podman run \
    ...
    sh -c "python3 /runtime/src/coreclr/scripts/superpmi.py asmdiffs -arch riscv64 -target_arch riscv64 -base_jit_path \$CORE_ROOT_BASE/libclrjit.so -mch_files \$ATEST/JIT/superpmi/superpmicollect/test.mch"
